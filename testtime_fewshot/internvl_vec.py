...
few_shots = [
    {
        "path": "/data1/cx/pred_VQA/dataset/VQA/vector/10004/315970822649927215-ls-1-2.png",
        "answer": "Yes, the directions of the two arrows match."
    },
    {
        "path": "/data1/cx/pred_VQA/dataset/VQA/vector/10001/315966078549927213-ls-0-1.png",
        "answer": "No, the directions of the two arrows don't match."
    },
]
...
def ask_smolvlm_fewshot(prompt: str, target_img_path: str, fewshots: list,
    ...
    for _ in range(num_samples):
        out = ask_smolvlm(prompt="You are an expert in determining the relationships between lane segments in the image. Let's determine if the directions of the two arrows match. Please reply in a brief sentence starting with 'Yes' or 'No'.", image_base64=target_b64, temperature=temperature)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", help="output result path", default="/data1/cx/pred_VQA/improved_result/testtime_fewshot/vec_result.txt")
    ...
    with open(args.txt, "r") as f:
        txt_prompt = f.read()
    exec(txt_prompt)
    txt_prompt="You are an expert in determining the relationships between lane segments in the image. Let's determine if the directions of the two arrows match. Please reply in a brief sentence starting with 'Yes' or 'No'."
