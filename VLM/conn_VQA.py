...
system_intel = '''
The red lines in the photos are lane boundaries. Two segments in different lanes don't have any connection relationship. 
Only two segments in the same lane end to end adjacent are considered as directly connected.
'''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--visual', help='visual prompt path', default='./dataset/VQA/connection')
    parser.add_argument('--output', help='output result path', default='./result/gpt4o/conn_result.txt')
    ...
    # openai.base_url="https://aizex.top/v1"
    ...
    for scene in range(10000, 10150):
        ...
        for img in imgs:
            try:
                ...
                result = ask_GPT4(txt_prompt, base64_image)
